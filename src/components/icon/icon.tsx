...
const iconComponents: Record<string, (color?: string, size?: number) => React.ReactElement> = {
  ...
  arrowDown: (color = "white", size = 24) => <AntDesign name="arrow-down" size={size} color={color} />,
